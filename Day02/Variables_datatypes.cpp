...
int main()
{
    // int datatype
    int a = 14;
    cout << "a is a variable and int is a datatype" << endl;
    // char datatype
    char ch = 'A';
    cout << "ch is a variable and char is a datatype" << endl;

    // float datatype
    float pi = 3.14;
    cout << "pi is a variable and float is a datatype" << endl;

    // long datatype
    long l = 1404;
    cout << "l is a variable and long is a datatype" << endl;

    // double datatype
    double d = 140402;
    cout << "d is a variable and double is a datatype" << endl;
